...
/**
 * A ValidateUserCommand.
 */
@Entity
@Table(name = "validate_user_command")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ValidateUserCommand implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ValidateUserCommand)) {
            return false;
        }
        return id != null && id.equals(((ValidateUserCommand) o).id);
    }
