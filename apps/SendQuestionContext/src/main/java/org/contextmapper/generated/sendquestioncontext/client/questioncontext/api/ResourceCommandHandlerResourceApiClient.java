...
@FeignClient(name="${resourceCommandHandlerResource.name:resourceCommandHandlerResource}", url="${resourceCommandHandlerResource.url:http://localhost:8092}", configuration = QuestionContextClientConfiguration.class)
