 ...
 */
@Entity
@Table(name = "notified_question")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NotifiedQuestion implements Serializable {
    ...
    public NotifiedQuestion id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public NotifiedQuestion questionResource(QuestionSent questionSent) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NotifiedQuestion)) {
            return false;
        }
        return id != null && id.equals(((NotifiedQuestion) o).id);
    }
