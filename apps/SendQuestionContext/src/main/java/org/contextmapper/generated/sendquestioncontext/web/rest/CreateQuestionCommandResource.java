...
import org.contextmapper.generated.sendquestioncontext.service.CreateQuestionCommandService;
...
/**
 * REST controller for managing {@link org.contextmapper.generated.sendquestioncontext.domain.CreateQuestionCommand}.
 */
@RestController
@RequestMapping("/api")
public class CreateQuestionCommandResource {
    ...
    private static final String ENTITY_NAME = "sendQuestionContextCreateQuestionCommand";
    ...
    public ResponseEntity<CreateQuestionCommand> createCreateQuestionCommand(@RequestBody CreateQuestionCommand createQuestionCommand)
        ...
        CreateQuestionCommand result = createQuestionCommandService.save(createQuestionCommand);
    ...
    public ResponseEntity<CreateQuestionCommand> updateCreateQuestionCommand(
        ...
        if (!createQuestionCommandRepository.existsById(id)) {
            throw new BadRequestAlertException("Entity not found", ENTITY_NAME, "idnotfound");
        }

        CreateQuestionCommand result = createQuestionCommandService.update(createQuestionCommand);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, createQuestionCommand.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<CreateQuestionCommand> partialUpdateCreateQuestionCommand(
        @PathVariable(value = "id", required = false) final Long id,
        @RequestBody CreateQuestionCommand createQuestionCommand
    ) throws URISyntaxException {
        ...
        Optional<CreateQuestionCommand> result = createQuestionCommandService.partialUpdate(createQuestionCommand);

        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, createQuestionCommand.getId().toString())
        );
    }
    ...
    public List<CreateQuestionCommand> getAllCreateQuestionCommands() {
    ...
    public ResponseEntity<CreateQuestionCommand> getCreateQuestionCommand(@PathVariable Long id) {
        log.debug("REST request to get CreateQuestionCommand : {}", id);
        Optional<CreateQuestionCommand> createQuestionCommand = createQuestionCommandService.findOne(id);
    ...
    public ResponseEntity<Void> deleteCreateQuestionCommand(@PathVariable Long id) {
        log.debug("REST request to delete CreateQuestionCommand : {}", id);
        createQuestionCommandService.delete(id);
        return ResponseEntity
            .noContent()
