...
public class ValidateResourceTagLinkageCommandDTO {

  private Long id;

  private QuestionResourceDTO questionId;

  public ValidateResourceTagLinkageCommandDTO id(Long id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public ValidateResourceTagLinkageCommandDTO questionId(QuestionResourceDTO questionId) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, validateResourceTagLinkageCommandDTO.id) &&
        Objects.equals(this.questionId, validateResourceTagLinkageCommandDTO.questionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValidateResourceTagLinkageCommandDTO {\n");
