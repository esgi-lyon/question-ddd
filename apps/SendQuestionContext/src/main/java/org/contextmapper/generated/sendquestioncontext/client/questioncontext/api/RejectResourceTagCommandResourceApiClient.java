...
@FeignClient(name="${rejectResourceTagCommandResource.name:rejectResourceTagCommandResource}", url="${rejectResourceTagCommandResource.url:http://localhost:8092}", configuration = QuestionContextClientConfiguration.class)
