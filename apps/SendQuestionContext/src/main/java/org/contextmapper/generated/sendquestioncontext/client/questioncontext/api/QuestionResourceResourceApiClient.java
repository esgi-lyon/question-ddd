...
@FeignClient(name="${questionResourceResource.name:questionResourceResource}", url="${questionResourceResource.url:http://localhost:8082}", configuration = QuestionContextClientConfiguration.class)
