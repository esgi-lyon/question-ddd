...
@FeignClient(name="${createCategoryCommandResource.name:createCategoryCommandResource}", url="${createCategoryCommandResource.url:http://localhost:8083}", configuration = SkillContextClientConfiguration.class)
