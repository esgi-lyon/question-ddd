...
@FeignClient(name="${validateResourceTagLinkageCommandResource.name:validateResourceTagLinkageCommandResource}", url="${validateResourceTagLinkageCommandResource.url:http://localhost:8082}", configuration = QuestionContextClientConfiguration.class)
