 ...
 */
@Entity
@Table(name = "created_question")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CreatedQuestion implements Serializable {
    ...
    public CreatedQuestion id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public CreatedQuestion questionAndTag(QuestionSent questionSent) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreatedQuestion)) {
            return false;
        }
        return id != null && id.equals(((CreatedQuestion) o).id);
    }
