...
@FeignClient(name="${tagCreatedEventResource.name:tagCreatedEventResource}", url="${tagCreatedEventResource.url:http://localhost:8083}", configuration = SkillContextClientConfiguration.class)
