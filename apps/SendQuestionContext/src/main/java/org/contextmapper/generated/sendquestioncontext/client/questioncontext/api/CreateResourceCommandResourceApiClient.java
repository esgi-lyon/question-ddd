...
@FeignClient(name="${createResourceCommandResource.name:createResourceCommandResource}", url="${createResourceCommandResource.url:http://localhost:8082}", configuration = QuestionContextClientConfiguration.class)
