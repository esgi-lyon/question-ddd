...
@FeignClient(name="${resourceRefusedAssociationEventResource.name:resourceRefusedAssociationEventResource}", url="${resourceRefusedAssociationEventResource.url:http://localhost:8082}", configuration = ClientConfiguration.class)
