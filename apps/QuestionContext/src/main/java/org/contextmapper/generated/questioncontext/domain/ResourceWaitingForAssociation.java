...
/**
 * A ResourceWaitingForAssociation.
 */
@Entity
@Table(name = "resource_waiting_for_association")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ResourceWaitingForAssociation implements Serializable {
    ...
    public ResourceWaitingForAssociation id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ResourceWaitingForAssociation questionId(QuestionResource questionResource) {
    ...
    public ResourceWaitingForAssociation tagId(QuestionResourceTagInfos questionResourceTagInfos) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceWaitingForAssociation)) {
            return false;
        }
        return id != null && id.equals(((ResourceWaitingForAssociation) o).id);
    }
