...
/**
 * A DTO for the {@link org.contextmapper.generated.questioncontext.domain.CreateResourceCommand} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CreateResourceCommandDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CreateResourceCommandDTO)) {
            return false;
        }
    ...
    public String toString() {
        return "CreateResourceCommandDTO{" +
            "id=" + getId() +
