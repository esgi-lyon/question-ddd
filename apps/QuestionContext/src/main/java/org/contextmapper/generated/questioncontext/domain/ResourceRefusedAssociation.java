...
/**
 * A ResourceRefusedAssociation.
 */
@Entity
@Table(name = "resource_refused_association")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ResourceRefusedAssociation implements Serializable {
    ...
    public ResourceRefusedAssociation id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ResourceRefusedAssociation questionId(QuestionResource questionResource) {
    ...
    public ResourceRefusedAssociation tagId(QuestionResourceTagInfos questionResourceTagInfos) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResourceRefusedAssociation)) {
            return false;
        }
        return id != null && id.equals(((ResourceRefusedAssociation) o).id);
    }
