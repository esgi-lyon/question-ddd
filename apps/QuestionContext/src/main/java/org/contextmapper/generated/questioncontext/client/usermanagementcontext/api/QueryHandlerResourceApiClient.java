...
@FeignClient(name="${queryHandlerResource.name:queryHandlerResource}", url="${queryHandlerResource.url:http://localhost:8081}", configuration = UserManagementClientConfiguration.class)
