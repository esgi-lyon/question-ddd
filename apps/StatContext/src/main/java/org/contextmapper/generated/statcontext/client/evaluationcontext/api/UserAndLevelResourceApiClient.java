...
@FeignClient(name="${userAndLevelResource.name:userAndLevelResource}", url="${userAndLevelResource.url:http://localhost:8096}", configuration = ClientConfiguration.class)
