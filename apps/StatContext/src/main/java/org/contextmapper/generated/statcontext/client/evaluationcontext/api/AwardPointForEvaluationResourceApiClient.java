...
@FeignClient(name="${awardPointForEvaluationResource.name:awardPointForEvaluationResource}", url="${awardPointForEvaluationResource.url:http://localhost:8096}", configuration = ClientConfiguration.class)
