...
@FeignClient(name="${awardedPointEventResource.name:awardedPointEventResource}", url="${awardedPointEventResource.url:http://localhost:8096}", configuration = ClientConfiguration.class)
