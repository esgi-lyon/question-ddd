...
@FeignClient(name="${createEvaluationCommandResource.name:createEvaluationCommandResource}", url="${createEvaluationCommandResource.url:http://localhost:8096}", configuration = ClientConfiguration.class)
