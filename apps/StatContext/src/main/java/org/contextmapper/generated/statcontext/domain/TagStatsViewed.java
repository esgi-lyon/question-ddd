 ...
 */
@Entity
@Table(name = "tag_stats_viewed")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TagStatsViewed implements Serializable {
    ...
    public TagStatsViewed id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public TagStatsViewed tag(StatisticSubjectTag statisticSubjectTag) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TagStatsViewed)) {
            return false;
        }
        return id != null && id.equals(((TagStatsViewed) o).id);
    }
