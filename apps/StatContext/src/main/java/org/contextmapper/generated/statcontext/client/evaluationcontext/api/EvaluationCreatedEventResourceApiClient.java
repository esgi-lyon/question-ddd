...
@FeignClient(name="${evaluationCreatedEventResource.name:evaluationCreatedEventResource}", url="${evaluationCreatedEventResource.url:http://localhost:8096}", configuration = ClientConfiguration.class)
