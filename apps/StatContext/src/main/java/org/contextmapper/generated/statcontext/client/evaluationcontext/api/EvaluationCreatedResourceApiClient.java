...
@FeignClient(name="${evaluationCreatedResource.name:evaluationCreatedResource}", url="${evaluationCreatedResource.url:http://localhost:8087}", configuration = ClientConfiguration.class)
