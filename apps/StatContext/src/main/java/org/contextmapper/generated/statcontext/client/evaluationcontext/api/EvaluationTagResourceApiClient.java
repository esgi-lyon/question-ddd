...
@FeignClient(name="${evaluationTagResource.name:evaluationTagResource}", url="${evaluationTagResource.url:http://localhost:8096}", configuration = ClientConfiguration.class)
