...
@FeignClient(name="${evaluatedAnswerResource.name:evaluatedAnswerResource}", url="${evaluatedAnswerResource.url:http://localhost:8087}", configuration = ClientConfiguration.class)
