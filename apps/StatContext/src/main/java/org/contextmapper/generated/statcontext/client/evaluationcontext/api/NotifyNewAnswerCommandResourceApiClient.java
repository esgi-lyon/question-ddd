...
@FeignClient(name="${notifyNewAnswerCommandResource.name:notifyNewAnswerCommandResource}", url="${notifyNewAnswerCommandResource.url:http://localhost:8096}", configuration = ClientConfiguration.class)
