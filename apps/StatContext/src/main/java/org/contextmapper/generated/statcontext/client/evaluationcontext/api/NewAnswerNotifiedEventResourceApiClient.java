...
@FeignClient(name="${newAnswerNotifiedEventResource.name:newAnswerNotifiedEventResource}", url="${newAnswerNotifiedEventResource.url:http://localhost:8096}", configuration = ClientConfiguration.class)
