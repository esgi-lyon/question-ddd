...
@FeignClient(name="${pointAwardRuleResource.name:pointAwardRuleResource}", url="${pointAwardRuleResource.url:http://localhost:8087}", configuration = ClientConfiguration.class)
