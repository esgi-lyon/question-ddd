...
@FeignClient(name="${answeringUserResource.name:answeringUserResource}", url="${answeringUserResource.url:http://localhost:8096}", configuration = ClientConfiguration.class)
