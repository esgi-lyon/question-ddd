...
@Service
@Transactional
public class StatisticCommandHandler extends ViewStatsCommandService {
    private final Logger log = LoggerFactory.getLogger(StatisticCommandHandler.class);
    ...
    public ViewStatsCommand handleViewStatsCommand(ViewStatsCommand viewStatsCommand) {
