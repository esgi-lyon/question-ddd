...
@FeignClient(name="${commandHandlersResource.name:commandHandlersResource}", url="${commandHandlersResource.url:http://localhost:8087}", configuration = ClientConfiguration.class)
