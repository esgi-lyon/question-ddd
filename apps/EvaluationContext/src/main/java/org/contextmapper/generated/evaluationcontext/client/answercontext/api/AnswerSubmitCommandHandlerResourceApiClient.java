...
@FeignClient(name="${answerSubmitCommandHandlerResource.name:answerSubmitCommandHandlerResource}", url="${answerSubmitCommandHandlerResource.url:http://localhost:8095}", configuration = ClientConfiguration.class)
