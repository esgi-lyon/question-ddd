...
@FeignClient(name="${answerSubmittedEventResource.name:answerSubmittedEventResource}", url="${answerSubmittedEventResource.url:http://localhost:8095}", configuration = ClientConfiguration.class)
