...
@FeignClient(name="${answerSubmitCommandResource.name:answerSubmitCommandResource}", url="${answerSubmitCommandResource.url:http://localhost:8085}", configuration = ClientConfiguration.class)
