...
@FeignClient(name="${availableAnswerResource.name:availableAnswerResource}", url="${availableAnswerResource.url:http://localhost:8095}", configuration = ClientConfiguration.class)
