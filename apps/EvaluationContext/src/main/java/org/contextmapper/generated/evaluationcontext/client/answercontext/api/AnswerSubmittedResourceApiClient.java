...
@FeignClient(name="${answerSubmittedResource.name:answerSubmittedResource}", url="${answerSubmittedResource.url:http://localhost:8095}", configuration = ClientConfiguration.class)
