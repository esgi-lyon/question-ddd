...
@Validated
@Tag(name = "tag-choices-list-query-resource", description = "the tag-choices-list-query-resource API")
public interface TagChoicesListQueryResourceApi {
    ...
    @Operation(
        ...
        tags = { "tag-choices-list-query-resource" },
        responses = {
