...
@FeignClient(name="${tagChoicesListResource.name:tagChoicesListResource}", url="${tagChoicesListResource.url:http://localhost:8085}", configuration = ClientConfiguration.class)
