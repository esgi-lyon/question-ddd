...
@FeignClient(name="${answerSubmitResource.name:answerSubmitResource}", url="${answerSubmitResource.url:http://localhost:8085}", configuration = ClientConfiguration.class)
