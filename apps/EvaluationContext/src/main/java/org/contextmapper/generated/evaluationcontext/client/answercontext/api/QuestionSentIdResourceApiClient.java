...
@FeignClient(name="${questionSentIdResource.name:questionSentIdResource}", url="${questionSentIdResource.url:http://localhost:8085}", configuration = ClientConfiguration.class)
