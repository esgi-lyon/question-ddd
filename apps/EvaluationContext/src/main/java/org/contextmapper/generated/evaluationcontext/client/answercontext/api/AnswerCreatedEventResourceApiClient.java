...
@FeignClient(name="${answerCreatedEventResource.name:answerCreatedEventResource}", url="${answerCreatedEventResource.url:http://localhost:8095}", configuration = ClientConfiguration.class)
