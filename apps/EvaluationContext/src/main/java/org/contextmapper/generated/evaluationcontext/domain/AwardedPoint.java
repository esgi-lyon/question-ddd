 ...
 */
@Entity
@Table(name = "awarded_point")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AwardedPoint implements Serializable {
    ...
    public AwardedPoint id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public AwardedPoint answer(EvaluatedAnswer evaluatedAnswer) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AwardedPoint)) {
            return false;
        }
        return id != null && id.equals(((AwardedPoint) o).id);
    }
