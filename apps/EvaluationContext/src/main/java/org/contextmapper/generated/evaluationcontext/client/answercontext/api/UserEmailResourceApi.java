...
@Validated
@Tag(name = "user-email-resource", description = "the user-email-resource API")
public interface UserEmailResourceApi {
    ...
    @Operation(
        ...
        tags = { "user-email-resource" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "*/*", array = @ArraySchema(schema = @Schema(implementation = UserEmailDTO.class)))
            })
        }
    )
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/api/user-emails",
        produces = "*/*"
    )
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "*/*", schema = @Schema(implementation = UserEmailDTO.class))
            })
        }
    )
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/api/user-emails/{id}",
        produces = "*/*"
    )
    ResponseEntity<UserEmailDTO> getUserEmail(
