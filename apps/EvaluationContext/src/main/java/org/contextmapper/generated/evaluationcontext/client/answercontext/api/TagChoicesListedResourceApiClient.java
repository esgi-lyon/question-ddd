...
@FeignClient(name="${tagChoicesListedResource.name:tagChoicesListedResource}", url="${tagChoicesListedResource.url:http://localhost:8085}", configuration = ClientConfiguration.class)
