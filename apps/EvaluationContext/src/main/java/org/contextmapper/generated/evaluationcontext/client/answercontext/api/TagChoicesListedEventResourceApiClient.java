...
@FeignClient(name="${tagChoicesListedEventResource.name:tagChoicesListedEventResource}", url="${tagChoicesListedEventResource.url:http://localhost:8095}", configuration = ClientConfiguration.class)
