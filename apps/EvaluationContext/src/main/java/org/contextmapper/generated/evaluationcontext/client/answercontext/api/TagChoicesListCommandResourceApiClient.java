...
@FeignClient(name="${tagChoicesListCommandResource.name:tagChoicesListCommandResource}", url="${tagChoicesListCommandResource.url:http://localhost:8085}", configuration = ClientConfiguration.class)
