...
@FeignClient(name="${addPreferencesCommandResource.name:addPreferencesCommandResource}", url="${addPreferencesCommandResource.url:http://localhost:8094}", configuration = SendQuestionClientConfiguration.class)
