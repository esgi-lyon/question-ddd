...
@FeignClient(name="${userPreferencesResource.name:userPreferencesResource}", url="${userPreferencesResource.url:http://localhost:8084}", configuration = ClientConfiguration.class)
