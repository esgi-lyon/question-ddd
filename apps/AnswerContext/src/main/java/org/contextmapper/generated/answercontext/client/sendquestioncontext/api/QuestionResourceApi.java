...
@Validated
@Tag(name = "question-resource", description = "the question-resource API")
public interface QuestionResourceApi {
    ...
    @Operation(
        ...
        tags = { "question-resource" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "*/*", array = @ArraySchema(schema = @Schema(implementation = QuestionDTO.class)))
            })
        }
    )
    @RequestMapping(
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "*/*", schema = @Schema(implementation = QuestionDTO.class))
            })
        }
    )
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/api/questions/{id}",
        produces = "*/*"
    )
