...
@FeignClient(name="${questionSentTagIdResource.name:questionSentTagIdResource}", url="${questionSentTagIdResource.url:http://localhost:8084}", configuration = ClientConfiguration.class)
