...
@FeignClient(name="${createQuestionResource.name:createQuestionResource}", url="${createQuestionResource.url:http://localhost:8084}", configuration = ClientConfiguration.class)
