...
@FeignClient(name="${viewTagsForQuestionCommandResource.name:viewTagsForQuestionCommandResource}", url="${viewTagsForQuestionCommandResource.url:http://localhost:8094}", configuration = SendQuestionClientConfiguration.class)
