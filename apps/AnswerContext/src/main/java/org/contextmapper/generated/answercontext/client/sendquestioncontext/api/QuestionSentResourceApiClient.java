...
@FeignClient(name="${questionSentResource.name:questionSentResource}", url="${questionSentResource.url:http://localhost:8084}", configuration = SendQuestionContextClientConfiguration.class)
