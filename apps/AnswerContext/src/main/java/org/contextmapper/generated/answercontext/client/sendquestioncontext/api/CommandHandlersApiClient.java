...
@FeignClient(name="${commandHandlers.name:commandHandlers}", url="${commandHandlers.url:http://localhost:8084}", configuration = SendQuestionContextClientConfiguration.class)
