...
@FeignClient(name="${userWithPreferencesIdResource.name:userWithPreferencesIdResource}", url="${userWithPreferencesIdResource.url:http://localhost:8084}", configuration = ClientConfiguration.class)
