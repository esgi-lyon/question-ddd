...
@Validated
@Tag(name = "query-handlers", description = "the query-handlers API")
public interface QueryHandlersApi {

    /**
     * GET /api/handlers/view-tags-for-question-query
     *
     * @param questionId  (required)
     * @return OK (status code 200)
     */
    @Operation(
        operationId = "handlePrepareQuestionsCommand1",
        tags = { "query-handlers" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/api/handlers/view-tags-for-question-query",
        produces = "*/*"
    )
    ResponseEntity<List<QuestionSentTagInfosDTO>> handlePrepareQuestionsCommand1(
