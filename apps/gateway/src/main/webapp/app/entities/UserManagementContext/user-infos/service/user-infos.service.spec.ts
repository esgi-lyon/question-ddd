...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../user-infos.test-samples';

import { UserInfosService } from './user-infos.service';

const requireRestSample: IUserInfos = {
...
describe('UserInfos Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a UserInfos', () => {
      ...
      const userInfos = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(userInfos).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a UserInfos', () => {
      const userInfos = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(userInfos).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addUserInfosToCollectionIfMissing', () => {
      it('should add a UserInfos to an empty array', () => {
        const userInfos: IUserInfos = sampleWithRequiredData;
      ...
      it("should add a UserInfos to an array that doesn't contain it", () => {
        const userInfos: IUserInfos = sampleWithRequiredData;
        const userInfosCollection: IUserInfos[] = [sampleWithPartialData];
        expectedResult = service.addUserInfosToCollectionIfMissing(userInfosCollection, userInfos);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(userInfos);
      });
      ...
      it('should add only unique UserInfos to an array', () => {
        const userInfosArray: IUserInfos[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const userInfosCollection: IUserInfos[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const userInfos: IUserInfos = sampleWithRequiredData;
        const userInfos2: IUserInfos = sampleWithPartialData;
    ...
    describe('compareUserInfos', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareUserInfos(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareUserInfos(entity1, entity2);
        const compareResult2 = service.compareUserInfos(entity2, entity1);
