...
export class EvaluationComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEvaluation): number => this.evaluationService.getEvaluationIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.evaluations = this.refineData(dataFromBody);
  }

  protected refineData(data: IEvaluation[]): IEvaluation[] {
