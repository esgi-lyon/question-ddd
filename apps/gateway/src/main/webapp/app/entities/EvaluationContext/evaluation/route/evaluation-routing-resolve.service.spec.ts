...
describe('Evaluation routing resolve service', () => {
  ...
  let resultEvaluation: IEvaluation | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEvaluation).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEvaluation>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
